      ...
      <img :src="img" alt="" v-for="img in goodsDetail.small_images" :onerror="defaultImg">
		...
		<div class="footer">
			...
			<div class="f_1 " @click="toCollect()">
				<x-icon type="ios-heart" size="22" style="padding-top:.16rem ;fill: #f23030;" v-show="collect"></x-icon>
				<x-icon type="ios-heart-outline" size="22" style="padding-top:.16rem ;fill: #f23030;" v-show="!collect"></x-icon>
