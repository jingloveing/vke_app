		...
		<div>
				...
				<div class="tab-swiper" v-show="index1==0">
					...
					<div>
						<div class="main_goods">
							<ul class="goods">
								<router-link tag="li" v-for="(goods,index) in goodsList.list" class="goods_list" to="" :key="index">
			...
			<div>
				<div class="tab-swiper" v-show="index1==1">
					<div>
						<ul class="video">
							<router-link tag="li" v-for="(item,index) in viewList.list" class="video_list" :to="{name:'Vedio',query:{id:item.id}}" :key="index">
...
<script>
	import { Tab, TabItem, Swiper, SwiperItem, PopupPicker, Divider, XSwitch ,Toast} from 'vux'
